...
public class DroneContainer {
    ...
    boolean forward = false, backward = false, left = false, right = false, up = false, down = false, ctrl = false,
            lift = false, land = false, yawLeft = false, yawRight = false;
    ...
    public void setkeyPressed(int key) {
        ...
        // maxPWM--;
        // }
        // if (e.getKeyCode() == ctrlKey ){// to change control keys (turn this off when
        // we merge)
        // ctrl = true;
        // System.out.println("right");
        // }
